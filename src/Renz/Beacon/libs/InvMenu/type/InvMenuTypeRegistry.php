...
use Renz\Beacon\libs\InvMenu\type\util\InvMenuTypeBuilders;
...
final class InvMenuTypeRegistry{
        ...
        public function __construct(){
                ...
                $this->register(InvMenuTypeIds::TYPE_BEACON, InvMenuTypeBuilders::BLOCK_ACTOR_FIXED()
                        ->setBlock(VanillaBlocks::BEACON())
                        ->setSize(1)
                        ->setBlockActorId("Beacon")
                        ->setNetworkWindowType(WindowTypes::BEACON)
                ->build());
        }
